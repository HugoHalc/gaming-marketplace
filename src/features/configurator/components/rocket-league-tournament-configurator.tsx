...
function rankFamily(rank: string) {
  return rankFamilies.find((item) => item.key === rank) ?? rankFamilies[0];
}
...
function CurrentRankSelector({
  ...
  const selectedFamily = rankFamily(value);
  ...
  return (
    <div className="min-w-0">
      ...
      <div role="radiogroup" aria-label="Tournament rank family" onKeyDown={handleRocketLeagueRadioGroupKeyDown} className="mt-4 grid grid-cols-4 gap-2">
...
export function RocketLeagueTournamentConfigurator({ gameSlug, service }: Props) {
  ...
  const selectedRank = rankFamily(String(selection.currentRank));
        ...
        <div className="flex flex-col gap-2 border-b border-white/[0.07] bg-gradient-to-br from-blue-500/[0.055] via-transparent to-transparent px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-6 sm:py-4">
          <div>
            ...
            <p className="mt-1 hidden text-sm text-[var(--muted-foreground)] sm:block">
              Configure your tournament boost around your rank, playlist, and preferred completion method.
            </p>
          </div>
                  ...
                  return (
                    ...
                    >
                      <span className="flex min-w-0 items-center gap-2.5">
                        <span className={`grid size-7 shrink-0 place-items-center rounded-lg border border-white/[0.07] bg-white/[0.025] ${platform.color}`}>
            ...
            <div>
              ...
              <div role="radiogroup" aria-label="Boost method" onKeyDown={handleRocketLeagueRadioGroupKeyDown} className="mt-3 grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`rounded-xl border p-3 text-left outline-none transition-[border-color,background-color,color] duration-200 ease-out motion-reduce:transition-none focus-visible:ring-2 focus-visible:ring-blue-300/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[#070A08] ${
                    boostMethod === "account"
                      ? "border-[#39E56F]/30 bg-[#39E56F]/[0.04] ring-1 ring-inset ring-white/[0.12]"
                      : "border-white/[0.08] bg-[#090D0B] hover:border-white/[0.14] hover:bg-[#0E1411]"
                  }`}
            ...
            <div className="p-4">
              <div className="rounded-xl border border-white/[0.07] bg-[#090D0B] px-3 py-3">
                <div className="flex items-center gap-2.5">
                  <Image src={selectedRank.image} alt="" width={30} height={30} className="size-7 shrink-0 object-contain" />
                  <div className="min-w-0">
