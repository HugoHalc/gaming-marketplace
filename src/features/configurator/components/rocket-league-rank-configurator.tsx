...
function CompactRankSelector({
  ...
  return (
    <div className="min-w-0">
      ...
      <div role="radiogroup" aria-label={`${title} rank family`} onKeyDown={handleRocketLeagueRadioGroupKeyDown} className="mt-4 grid grid-cols-3 gap-2 min-[390px]:grid-cols-4">
        {visibleFamilies.map((family) => {
          ...
          return (
            ...
            >
              ...
              <span className={`mt-2 line-clamp-2 min-h-8 w-full text-center text-[11px] font-semibold leading-4 transition-colors ${
          ...
          {selectedFamily.tiers.map((tier) => {
            ...
            return (
              <button
                ...
                className={`h-9 min-w-11 rounded-lg border px-3 text-xs font-bold outline-none transition-[border-color,background-color,color,box-shadow] focus-visible:ring-2 focus-visible:ring-blue-300/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[#070A08] ${
                  active
                ...
                {platforms.map((platform) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex h-11 items-center justify-between gap-3 rounded-xl border px-3 text-left outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-300/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[#070A08] ${
                        active
              ...
              <div role="radiogroup" aria-label="Boost method" onKeyDown={handleRocketLeagueRadioGroupKeyDown} className="mt-3 grid gap-2 sm:grid-cols-2">
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-[10px] font-bold text-[#82F5A4]">Base</span>
                  </div>
                  <p className="mt-2 text-sm font-semibold text-[#F4F7F5]">Account Boost</p>
                </button>
                ...
                >
                  ...
                  <p className="mt-2 text-sm font-semibold text-[#F4F7F5]">Play With Booster</p>
                </button>
              </div>
            ...
            <div className="p-4">
              <div className="rounded-xl border border-white/[0.07] bg-[#090D0B] px-3 py-3">
                <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2">
                  ...
                  <ArrowRight className="size-3.5 text-blue-200/35" />
