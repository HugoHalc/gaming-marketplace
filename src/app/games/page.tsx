        ...
        <Container>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {launchGames.map((game) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${visuals[game.accent]}`} />
                ...
                <div className="relative flex min-h-[19rem] flex-col p-6 sm:p-7">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="rounded-full border border-white/[0.08] bg-black/20 px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[0.12em] text-white/40">
                      Launch title
                    </span>
                  </div>
                  <div className="mt-auto">
                    ...
                    <div className="mt-5 flex items-center justify-between">
                      <span className="text-xs text-white/40">Open game storefront</span>
                      <span className="grid size-9 place-items-center rounded-full border border-white/[0.08] bg-white/[0.03] text-white/70 transition-colors group-hover:border-green-400/25 group-hover:bg-green-400/[0.08] group-hover:text-green-300">
