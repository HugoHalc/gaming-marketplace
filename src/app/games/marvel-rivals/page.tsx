      ...
      <section className="relative isolate overflow-hidden border-b border-white/[0.06] bg-[#050807]">
        ...
        >
          <Image
            ...
            quality={100}
            className="object-cover object-[76%_50%] opacity-38 sm:object-[73%_50%] sm:opacity-62 md:object-[70%_50%] md:opacity-78 lg:object-contain lg:object-right lg:opacity-94 xl:opacity-100"
          />
