  ...
  return (
    <>
      ...
      >
        ...
        <aside
          className={`absolute inset-y-0 right-0 flex w-full max-w-[430px] flex-col border-l border-white/[0.07] bg-[#050807] transition-transform duration-[260ms] ${
        ...
        >
          <div className="flex min-h-20 items-center justify-between gap-4 border-b border-white/[0.06] px-5 pt-[max(.5rem,env(safe-area-inset-top))]">
            ...
            {signedIn ? (
              <>
                ...
                >
                  ...
                  <span className="flex-1 text-[15px] font-medium">Account Settings</span>
