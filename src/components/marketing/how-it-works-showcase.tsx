...
function MockupShell({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[22px] border border-white/[0.085] bg-[#080D0A] shadow-[0_14px_34px_-30px_rgba(57,229,111,.30)] ${className}`}
    >
      <div className="pointer-events-none absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-[#39E56F]/14 to-transparent" />
      <div className="pointer-events-none absolute right-4 top-4 size-4 border-r border-t border-white/[0.045]" />
      {children}
    </div>
  );
}
...
function GameSelectionVisual() {
  return (
    <div className="relative mx-auto h-[300px] w-full max-w-[560px] sm:h-[340px]">
      ...
      <div className="absolute left-[10%] top-[14%] w-[58%] -rotate-[4deg] overflow-hidden rounded-[20px] border border-white/[0.09] bg-[#0B100D] shadow-[0_14px_32px_-28px_rgba(57,229,111,.28)] motion-safe:transition-transform motion-safe:duration-300 lg:group-hover:translate-y-[-3px] lg:group-hover:rotate-[-3deg]">
        <div className="relative aspect-[16/8.7] overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#050807]/92 via-[#050807]/18 to-transparent" />
          <div className="absolute inset-x-0 bottom-0 p-4">
            <p className="font-gaming-label text-[9px] uppercase tracking-[0.10em] text-blue-100/75">
              Rocket League
            </p>
      ...
      <div className="absolute bottom-[6%] right-[6%] w-[54%] rotate-[4deg] overflow-hidden rounded-[20px] border border-rose-300/14 bg-[#0B100D] shadow-[0_14px_32px_-28px_rgba(57,229,111,.28)] motion-safe:transition-transform motion-safe:duration-300 lg:group-hover:translate-y-[-4px] lg:group-hover:rotate-[3deg]">
        <div className="relative aspect-[16/8.7] overflow-hidden">
          <Image
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#050807]/92 via-[#050807]/18 to-transparent" />
          <div className="absolute inset-x-0 bottom-0 p-4">
            <p className="font-gaming-label text-[9px] uppercase tracking-[0.10em] text-rose-100/75">
              Valorant
            </p>
  ...
  return (
    <MockupShell className="mx-auto w-full max-w-[560px] p-4 sm:p-5">
      <div className="flex items-center justify-between gap-3 border-b border-white/[0.06] pb-4">
        ...
        <span className="rounded-full border border-[#39E56F]/18 bg-[#39E56F]/[0.045] px-2.5 py-1 text-[9px] font-semibold text-[#82F5A4]">
          Live pricing
        </span>
      </div>

      <div className="mt-4 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
        <div className="rounded-[14px] border border-white/[0.07] bg-[#0E1411] p-3">
          <p className="font-gaming-label text-[9px] uppercase tracking-[0.09em] text-[#7C8780]">Current</p>
        ...
        <div className="rounded-[14px] border border-white/[0.07] bg-[#0E1411] p-3">
          <p className="font-gaming-label text-[9px] uppercase tracking-[0.09em] text-[#7C8780]">Target</p>
          <div className="mt-2 flex items-center gap-2.5">
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        <div className="rounded-[14px] border border-white/[0.07] bg-[#0B100D] p-3.5">
          <div className="flex items-center gap-2">
            <Gamepad2 className="size-3.5 text-[#7C8780]" />
            <span className="text-[10px] font-semibold text-[#F4F7F5]">Mode</span>
          </div>
          <div className="mt-3 grid grid-cols-2 gap-2">
            <span className="rounded-lg border border-[#39E56F]/20 bg-[#39E56F]/[0.05] px-2.5 py-2 text-center text-[9px] font-semibold text-[#82F5A4]">Solo</span>
        ...
        <div className="rounded-[14px] border border-white/[0.07] bg-[#0B100D] p-3.5">
          <div className="flex items-center gap-2">
            <SlidersHorizontal className="size-3.5 text-[#7C8780]" />
            <span className="text-[10px] font-semibold text-[#F4F7F5]">Extras</span>
          </div>
          <div className="mt-3 flex flex-wrap gap-1.5">
            <span className="rounded-full border border-white/[0.07] px-2 py-1 text-[9px] text-[#A0AAA4]">Express</span>
            <span className="rounded-full border border-white/[0.07] px-2 py-1 text-[9px] text-[#A0AAA4]">Streaming</span>
          </div>
        </div>
      </div>
    </MockupShell>
  ...
  return (
    <MockupShell className="mx-auto w-full max-w-[560px] p-4 sm:p-5">
      <div className="flex items-center justify-between gap-4 border-b border-white/[0.06] pb-4">
        ...
        <span className="grid size-9 place-items-center rounded-[11px] border border-[#39E56F]/18 bg-[#39E56F]/[0.035]">
          <ShieldCheck className="size-4 text-[#82F5A4]/85" />
        </span>
      </div>

      <div className="mt-4 grid gap-3 sm:grid-cols-[1.15fr_.85fr]">
        <div className="rounded-[14px] border border-white/[0.07] bg-[#0B100D] p-4">
          <div className="flex items-center gap-3">
            <span className="grid size-9 place-items-center rounded-[11px] border border-[#39E56F]/15 bg-[#39E56F]/[0.04] text-[#82F5A4]">
              <Check className="size-4" />
            </span>
            <div>
              <p className="text-[10px] font-semibold text-[#F4F7F5]">Order tracking</p>
              <p className="mt-0.5 text-[9px] leading-4 text-[#7C8780]">Follow each stage from your dashboard</p>
            </div>
          </div>
          ...
          <div className="mt-5 space-y-3">
            {["Order placed", "Booster assigned", "Service in progress"].map((label, index) => (
              <div key={label} className="flex items-center gap-3">
                ...
                <span className="text-[10px] text-[#A0AAA4]">{label}</span>
        ...
        <div className="space-y-3">
          <div className="rounded-[14px] border border-white/[0.07] bg-[#0B100D] p-4">
            <div className="flex items-center gap-2">
              <MessageSquare className="size-3.5 text-[#82F5A4]/70" />
              <p className="text-[10px] font-semibold text-[#F4F7F5]">Live order chat</p>
            </div>
            <div className="mt-3 space-y-2">
              <div className="h-7 w-[82%] rounded-lg bg-white/[0.035]" />
              <div className="ml-auto h-7 w-[70%] rounded-lg border border-[#39E56F]/10 bg-[#39E56F]/[0.035]" />
            </div>
          </div>

          <div className="rounded-[14px] border border-white/[0.07] bg-[#0B100D] p-4">
            <div className="flex items-center gap-2">
              <CreditCard className="size-3.5 text-[#7C8780]" />
              <p className="text-[10px] font-semibold text-[#F4F7F5]">Secure checkout</p>
            </div>
            <p className="mt-2 text-[9px] leading-4 text-[#7C8780]">Payment and order access remain connected to your account.</p>
          </div>
        </div>
      </div>
    </MockupShell>
    ...
    >
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          <p className="font-gaming-label text-[11px] uppercase tracking-[0.12em] text-[#82F5A4]/80">
            How it works
          </p>
              ...
              >
                <div className="max-w-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-gaming-label text-[10px] uppercase tracking-[0.11em] text-[#7C8780]">
                      {step.eyebrow}
                    </span>
                  </div>
